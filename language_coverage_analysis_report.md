...
- Workbook updated in place: `ka11y_coverage_report.xlsx`
...
- Percentage: 50%
- Area: detection
- Files: `ka11y-node/src/controllers/accessibility.controller.js; ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/api/v1/combined/runner.py`
...
- Percentage: 100%
- Area: fallback
- Files: `ka11y-node/src/utils/rulesLoader.js; ka11y-python/ka11y/i18n/loader.py; i18n/rules.yml; i18n/locales/ja.yml`
...
- Percentage: 50%
- Area: prompts
- Files: `config/universal.yml; ka11y-node/src/custom-checks/sharedAssets.js; ka11y-python/ka11y/accessibility/rules/media/media_auditor.py; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py`
...
- Percentage: 50%
- Area: parsing
- Files: `ka11y-python/ka11y/text_detector/ocrbase.py; ka11y-python/ka11y/text_detector/paddleocrbase.py; ka11y-python/ka11y/accessibility/rules/non_text/sensory_auditor.py; ka11y-python/ka11y/accessibility/rules/input_modalities/label_in_name_auditor.py; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py`
...
- Percentage: 50%
- Area: validation
- Files: `ka11y-python/ka11y/accessibility/rules/forms/form_auditor.py; ka11y-python/ka11y/accessibility/rules/non_text/sensory_auditor.py; ka11y-python/ka11y/accessibility/rules/input_modalities/label_in_name_auditor.py; ka11y-python/ka11y/accessibility/rules/media/quality_engine.py`
...
- Percentage: 75%
- Area: reporting
- Files: `ka11y-node/src/utils/axeResultMapper.js; ka11y-python/ka11y/api/v1/combined/findings.py; ka11y-python/ka11y/api/v1/combined/report.py`
...
- Percentage: 50%
- Area: export
- Files: `ka11y-python/ka11y/api/v1/combined/report.py; ka11y-python/ka11y/api/v1/rules/metadata.py`
...
- Percentage: 50%
- Area: tests
- Files: `ka11y-node/tests/services/accessibility.service.flat.test.js; ka11y-node/tests/utils/axeResultMapper.custom-flat.test.js; ka11y-node/tests/custom-checks/sharedAssets.test.js; ka11y-python/tests/test_alt_text_auditor.py; ka11y-python/tests/test_media_auditor.py; ka11y-python/tests/test_target_size_auditor.py`
...
- Files: `ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/api/v1/combined/runner.py`
...
- Percentage: 50%
- Area: end-to-end
- Files: `ka11y-python/ka11y/api/v1/combined/runner.py; ka11y-python/ka11y/api/v1/combined/report.py; ka11y-python/tests/test_image_audit_stage.py; ka11y-python/tests/test_media_auditor.py`
...
|---|---|---:|---|---|---|---|---|
| 1.1.1 Non-text Content | Covered | 75% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; AltTextAccessibilityAuditor.generate_audit_report; _make_finding | SC is wired through run_image_audit; the Python image audit emits 1.1.1/1.4.5/1.4.11/4.1.2 records and combined findings localize criterion labels. | Japanese alt-text tests fail for logo/action terms in tests/test_alt_text_auditor.py (logo, button, and image-name paths). |
| 1.2.1 Audio-only and Video-only | Partially Covered | 50% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/media/media_auditor.py; ka11y-python/ka11y/accessibility/rules/media/quality_engine.py | RULE_FLAGS; MediaAuditor.generate_audit_report; _run_quality_checks | SC is wired through run_media_audit; transcript detection runs in Gates 1-4, and Gate 5 quality checks import quality_engine.py for deeper validation. | Gate 5 quality checks fail in the current environment because quality_engine.py imports nltk and faster_whisper; labeled-alternative keywords are English-only. |
| 1.2.2 Captions (Prerecorded) | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Track presence is detectable, but caption timing and wording are not verified automatically. |
| 1.3.1 Info and Relationships | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | If a page uses visual tricks to look like a table but lacks the code, it requires human review. |
| 1.3.2 Meaningful Sequence | Covered | 75% | A | ka11y-node/src/custom-checks/meaningful-sequence.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Sequence coverage is heuristic rather than a full keyboard walkthrough. |
| 1.3.3 Sensory Characteristics | Partially Covered | 50% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/non_text/sensory_auditor.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | tests/test_sensory_auditor.py passes, but the rule is still regex/NLP heuristic, not full semantic understanding. |
| 1.3.4 Orientation | Covered | 75% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/orientation.py; ka11y-node/src/custom-checks/orientation.check.js | RULE_FLAGS; rendered evaluator; check; _run_job | Orientation evidence is collected from rendered-layout checks and Node-side custom checks, then merged in the combined runner. | Some specific mobile-device hardware locks cannot be simulated on a server. |
| 1.3.5 Identify Input Purpose | Covered | 100% | AA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Relies entirely on standard HTML implementation. |
| 1.4.1 Use of Color | Covered | 75% | A | ka11y-node/src/custom-checks/use-of-color.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Links drawn inside a graphical canvas are not readable. |
| 1.4.2 Audio Control | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Highly obfuscated background audio injections might evade detection. |
| 1.4.3 Contrast (Minimum) | Partially Covered | 50% | AA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py | AccessibilityService.analyseUrlFlat; mapResultsFlat; AltTextAccessibilityAuditor.generate_audit_report | Node runs axe contrast rules while the Python image audit adds OCR-backed contrast/image evidence where text is rendered inside images. | OCR-backed contrast depends on detectable text regions and remains weak on complex gradients/backgrounds. |
| 1.4.4 Resize text | Partially Covered | 50% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/resize_text.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; rendered evaluator; _run_job | SC is routed through run_resize_text_audit and executed inside the rendered-layout pipeline before being merged into combined output. | Resize-text audits are rendered-layout heuristics rather than a browser-native zoom oracle. |
| 1.4.5 Images of Text | Partially Covered | 50% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; AltTextAccessibilityAuditor.generate_audit_report; _make_finding | SC is wired through run_image_audit; the Python image audit emits 1.1.1/1.4.5/1.4.11/4.1.2 records and combined findings localize criterion labels. | Japanese logo/CJK image-text cases and one complex-chart OCR exemption fail in tests/test_alt_text_auditor.py. |
| 1.4.6 Contrast (Enhanced) | Covered | 75% | AAA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py | AccessibilityService.analyseUrlFlat; mapResultsFlat; AltTextAccessibilityAuditor.generate_audit_report | Node runs axe contrast rules while the Python image audit adds OCR-backed contrast/image evidence where text is rendered inside images. | Same limitations as standard contrast. |
| 1.4.10 Reflow | Partially Covered | 50% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/reflow.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Hidden overflowing text on parent elements can occasionally mask internal breaks. |
| 1.4.11 Non-text Contrast | Partially Covered | 25% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Coverage is limited to machine-segmentable controls/images; complex graphics remain difficult to score automatically. |
| 1.4.12 Text Spacing | Covered | 75% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/input_modalities/text_spacing_auditor.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; generate_audit_report; _run_job | SC is wired through run_text_spacing_audit and merged into the combined report; targeted text-spacing tests pass. | Rendered-layout tests pass, but no dedicated Japanese end-to-end text-spacing test was found. |
| 1.4.13 Content on Hover or Focus | Partially Covered | 50% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/hover_focus_content.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Focus-only popovers that behave entirely differently than mouse hovers can be under-modeled. |
| 2.1.1 Keyboard | Partially Covered | 50% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | No full keyboard traversal auditor exists; coverage is mostly axe/static focus signals. |
| 2.1.2 No Keyboard Trap | Covered | 75% | A | ka11y-node/src/custom-checks/keyboard-trap.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Closed or highly customized shadow components limit deep tracking. |
| 2.1.4 Character Key Shortcuts | Covered | 75% | A | ka11y-node/src/custom-checks/character-key-shortcuts.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Shortcuts tied deeply into complex frameworks like React can be invisible to initial scans. |
| 2.2.1 Timing Adjustable | Partially Covered | 25% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Evidence is limited to meta refresh/redirect signals; JavaScript timers are not comprehensively observed. |
| 2.2.2 Pause, Stop, Hide | Partially Covered | 50% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/timing/pause_stop_hide_auditor.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; generate_audit_report; _run_job | Pause/stop/hide is routed through a dedicated Python auditor and merged into the combined report. | Pause/stop/hide logic exists, but custom JavaScript animations can evade automated detection. |
| 2.2.4 Interruptions | Partially Covered | 25% | AAA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Evidence is limited to static interruption signals, not full runtime interruption behavior. |
| 2.4.1 Bypass Blocks | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Relies on correct semantic HTML coding practices. |
| 2.4.2 Page Titled | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | None. |
| 2.4.3 Focus Order | Partially Covered | 50% | A | ka11y-node/src/utils/axeResultMapper.js; ka11y-node/src/services/accessibility.service.js | RULE_SC_FALLBACK; AccessibilityService.analyseUrlFlat | The SC is inferred from fallback mappings over best-practice/focus signals rather than from a dedicated end-to-end rule engine. | Mapped mainly through fallback focus-order/tabindex signals, not a full tab-order validator. |
| 2.4.4 Link Purpose (In Context) | Partially Covered | 50% | A | ka11y-node/src/custom-checks/link-purpose.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Meaningful link purpose in context still requires human judgment beyond current heuristics. |
| 2.4.5 Multiple Ways | Covered | 75% | AA | ka11y-node/src/custom-checks/multiple-ways.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Single-page detection cannot prove site-wide alternate navigation paths. |
| 2.4.6 Headings and Labels | Partially Covered | 50% | AA | ka11y-node/src/utils/axeResultMapper.js; ka11y-node/src/services/accessibility.service.js | RULE_SC_FALLBACK; AccessibilityService.analyseUrlFlat | The SC is inferred from fallback mappings over best-practice/focus signals rather than from a dedicated end-to-end rule engine. | Coverage is mostly heading heuristics, not full label quality or semantic clarity checks. |
| 2.4.7 Focus Visible | Covered | 75% | AA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Delayed animations can hide the outline during our capture window. |
| 2.4.8 Location | Covered | 75% | AAA | ka11y-node/src/custom-checks/location.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Breadcrumb/location cues are detectable, but purely visual state indicators are out of scope. |
| 2.4.9 Link Purpose (Link Only) | Covered | 75% | AAA | ka11y-node/src/custom-checks/link-purpose.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Phrase heuristics help, but hidden/contextual cues still need review. |
| 2.4.11 Focus Not Obscured (Minimum) | Partially Covered | 50% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/focus_not_obscured_minimum.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Rendered overlap detection exists, but obscuration remains heuristic in dynamic layouts. |
| 2.4.12 Focus Not Obscured (Enhanced) | Partially Covered | 50% | AAA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rendered/evaluators/focus_not_obscured_enhanced.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Same rendered-layout limitations as 2.4.11, with stricter thresholds. |
| 2.4.13 Focus Appearance | Covered | 75% | AA | ka11y-node/src/custom-checks/focus-appearance.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Complex shadow implementations can occasionally confuse our pixel boundaries. |
| 2.5.2 Pointer Cancellation | Covered | 75% | A | ka11y-node/src/custom-checks/pointer-cancellation.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Obfuscated framework click listeners evade raw code inspection. |
| 2.5.3 Label in Name | Covered | 75% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/input_modalities/label_in_name_auditor.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; LabelInNameAuditor.generate_audit_report; _run_job | SC is wired through run_label_in_name_audit, and the auditor contains explicit CJK detection/sub-string logic with passing Japanese tests. | CJK substring matching tests pass, but /analyse-url rule handlers in run_router.py hardcode lang=en for URL-only rule routes. |
| 2.5.7 Dragging Movements | Covered | 75% | AA | ka11y-node/src/custom-checks/dragging-movements.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Completely custom dragging scripts lack predictable signatures. |
| 2.5.8 Target Size (Minimum) | Covered | 75% | AA | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/input_modalities/target_size_auditor.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; generate_audit_report; _run_job | SC is wired through run_target_size_audit and most targeted tests pass. | Target-size logic largely works, but tests/test_target_size_auditor.py still fails one CSV schema check. |
| 3.1.1 Language of Page | Covered | 100% | A | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | None. |
| 3.1.2 Language of Parts | Covered | 100% | AA | ka11y-node/src/services/accessibility.service.js; ka11y-node/src/utils/axeResultMapper.js | AccessibilityService.analyseUrlFlat; _tagsForLevel; mapResultsFlat | Node runs axe-core with WCAG tag filters and localizes flat findings by lang; targeted Jest tests confirm locale application and Japanese label mapping. | Requires manual QA to ensure language shifts are actually tagged. |
| 3.1.6 Pronunciation | Covered | 75% | AAA | ka11y-node/src/custom-checks/pronunciation.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Pronunciation coverage is Japanese-aware, but only for ruby/furigana patterns visible in the DOM. |
| 3.2.1 On Focus | Covered | 75% | A | ka11y-node/src/custom-checks/on-focus.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Silent single-page app visual shifts might look like redirects to the scanner. |
| 3.2.2 On Input | Covered | 75% | A | ka11y-node/src/custom-checks/on-input.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Server-side only submissions without navigation evade detection. |
| 3.2.6 Consistent Help | Covered | 75% | AA | ka11y-node/src/custom-checks/consistent-help.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Consistency claims need multi-page evidence; single-page scans only provide partial proof. |
| 3.3.1 Error Identification | Partially Covered | 50% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/forms/form_auditor.py; ka11y-python/ka11y/api/v1/combined/findings.py | RULE_FLAGS; generate_audit_report / evaluator; _make_finding | SC is wired through RULE_FLAGS to a dedicated Python auditor/evaluator, and the findings layer localizes criterion labels through the shared i18n loader. | Form auditor checks programmatic associations, not actual submitted error wording or server-side behavior. |
| 3.3.2 Labels or Instructions | Covered | 75% | A | ka11y-python/ka11y/api/v1/rules/run_router.py; ka11y-python/ka11y/accessibility/rules/forms/form_auditor.py; ka11y-python/ka11y/api/v1/combined/runner.py | RULE_FLAGS; FormAccessibilityAuditor.generate_audit_report; _run_job | SC is wired through run_form_audit; the form auditor checks labels, required indicators, and programmatic error association before findings are merged into the combined report. | Japanese required-marker heuristics exist and pass tests, but instruction quality still needs review. |
| 3.3.3 Error Suggestion | Covered | 75% | AA | ka11y-node/src/custom-checks/error-suggestion.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Evidence relies on keyword/template heuristics; dynamic tooltip validations are hard to trigger automatically. |
| 3.3.4 Error Prevention (Legal, Financial) | Covered | 75% | AA | ka11y-node/src/custom-checks/error-prevention.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Keyword heuristics cover transaction/legal cues but not every application state. |
| 3.3.7 Redundant Entry | Covered | 75% | A | ka11y-node/src/custom-checks/redundant-entry.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Redundancy detection is heuristic and backend data reuse is not observable from the frontend. |
| 3.3.8 Accessible Authentication | Covered | 75% | AA | ka11y-node/src/custom-checks/accessible-auth.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Third-party CAPTCHA or auth iframes remain opaque to DOM-level checks. |
| 4.1.1 Parsing | Covered | 100% | A | ka11y-node/src/custom-checks/html-parsing.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Not a replacement for full W3C HTML validation. |
| 4.1.2 Name, Role, Value | Covered | 75% | A | ka11y-node/src/services/accessibility.service.js; ka11y-python/ka11y/accessibility/rules/non_text/alttext.py; ka11y-python/ka11y/api/v1/combined/runner.py | AccessibilityService.analyseUrlFlat; _check_4_1_2; _run_job | General 4.1.2 coverage comes from axe-core in Node, while functional-image accessible-name checks come from the Python image audit and are merged in the combined runner. | Strong axe coverage exists, but the Japanese logo-name path in the Python image audit still fails a targeted alt-text test. |
| 4.1.3 Status Messages | Covered | 75% | AA | ka11y-node/src/custom-checks/status-messages.check.js; ka11y-node/src/custom-checks/sharedAssets.js; config/universal.yml | check; runAll; renderReasonTemplate/getKeywordList | A Node custom check runs through runAll(page, { lang }); sharedAssets resolves en/ja assets from universal.yml, and targeted Jest coverage exists for localized behavior. | Localized status-message heuristics exist, but silent runtime updates may still be missed. |
...
- High: Japanese alt-text/image coverage is overstated by the existing workbook narratives. ka11y-python/ka11y/accessibility/rules/non_text/alttext.py and tests/test_alt_text_auditor.py show English-only logo/action heuristics and four failing Japanese-focused tests.
- High: WCAG 1.2.1 media quality automation is not reliably executable in the current environment. ka11y-python/ka11y/accessibility/rules/media/quality_engine.py imports nltk and faster_whisper; targeted pytest slices fail with ModuleNotFoundError.
- High: Per-rule URL-only handlers bypass Japanese routing. ka11y-python/ka11y/api/v1/rules/run_router.py:create_rule_url_only_handler hardcodes lang="en".
- Medium: Some advertised automation is proxy-only, not criterion-complete. 2.4.3 and 2.4.6 depend on RULE_SC_FALLBACK mappings in ka11y-node/src/utils/axeResultMapper.js.
...
- `ka11y-node/src/controllers/accessibility.controller.js` — `analyze; analyseUrlFlat; analyseUrl`
- `ka11y-node/src/services/accessibility.service.js` — `_sanitizeLocaleLang; _configureAxeLocale; analyseUrlFlat`
- `ka11y-node/src/utils/rulesLoader.js` — `getRules; getLocaleData; getAxeRuleLocales`
- `ka11y-node/src/utils/axeResultMapper.js` — `mapResultsFlat; mapCustomResultsFlat; RULE_SC_FALLBACK`
- `ka11y-node/src/custom-checks/sharedAssets.js` — `sanitizeLang; getKeywordList; renderReasonTemplate`
...
- `ka11y-python/ka11y/i18n/loader.py` — `load_rules; get_wcag_names; get_suggested_fixes`
- `ka11y-python/ka11y/api/v1/rules/metadata.py` — `get_wcag_rules`
- `ka11y-python/ka11y/api/v1/rules/run_router.py` — `RULE_FLAGS; create_rule_url_only_handler`
- `ka11y-python/ka11y/api/v1/combined/runner.py` — `_run_job; _merge_findings`
- `ka11y-python/ka11y/api/v1/combined/findings.py` — `_lang_ctx; _make_finding`
- `ka11y-python/ka11y/api/v1/combined/report.py` — `_build_report`
- `ka11y-python/ka11y/text_detector/ocrbase.py` — `get_ocr_reader`
- `ka11y-python/ka11y/text_detector/paddleocrbase.py` — `get_ocr_reader`
- `ka11y-python/ka11y/accessibility/rules/non_text/sensory_auditor.py` — `_detect_lang and Japanese sensory taxonomies`
- `ka11y-python/ka11y/accessibility/rules/input_modalities/label_in_name_auditor.py` — `_contains_cjk; _label_in_name`
- `ka11y-python/ka11y/accessibility/rules/forms/form_auditor.py` — `_REQUIRED_PATTERN; generate_audit_report`
- `ka11y-python/ka11y/accessibility/rules/non_text/alttext.py` — `_check_1_1_1_logo; _check_1_1_1_button; _check_4_1_2; _check_1_4_5`
- `ka11y-python/ka11y/accessibility/rules/media/media_auditor.py` — `_gate_4_find_transcript; generate_audit_report`
- `ka11y-python/ka11y/accessibility/rules/media/quality_engine.py` — `import-time dependencies and Gate 5 checks`
- `ka11y-node/tests/services/accessibility.service.flat.test.js` — `lang=ja locale wiring test`
- `ka11y-node/tests/utils/axeResultMapper.custom-flat.test.js` — `Japanese criterion/reason localization tests`
- `ka11y-node/tests/custom-checks/sharedAssets.test.js` — `multilingual keyword/template tests`
- `ka11y-python/tests/test_alt_text_auditor.py` — `Japanese image-path failures`
- `ka11y-python/tests/test_media_auditor.py` — `media dependency failures`
- `ka11y-python/tests/test_target_size_auditor.py` — `CSV schema drift`
