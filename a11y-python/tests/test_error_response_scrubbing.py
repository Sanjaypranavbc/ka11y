...
from a11y.api.v1.combined import store as combined_store
from a11y.api.v1 import crawl as crawl_api
...
def test_crawl_route_scrubs_exception_message(monkeypatch, client, caplog):
    ...
    # the scrubbing path still ran, but AC_*.log filled with confusing
    ...
    class _IntentionalTestCrawlerFailure:
        def __init__(self, *a, **k):
            self.output_dir = "/tmp/a11y-scrubbing-test"
...
def test_pipeline_route_scrubs_exception_message(monkeypatch, client, caplog):
    ...
    from a11y.api.v1 import pipeline as pipeline_api
