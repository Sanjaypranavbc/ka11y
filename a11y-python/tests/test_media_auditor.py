...
from a11y.accessibility.rules.media.media_auditor import (
    MediaAuditor,
...
class TestQualityEngineTextChecks:
    ...
    def test_speaker_ids_found(self):
        from a11y.accessibility.rules.media.quality_engine import _check_speaker_ids
    ...
    def test_non_speech_events_found(self):
        from a11y.accessibility.rules.media.quality_engine import _check_non_speech_events
    ...
    def test_transcript_preparation_vtt(self):
        from a11y.accessibility.rules.media.quality_engine import _prepare_transcript
...
class TestCheckVerbatim:
    ...
    def test_identical_texts_pass(self):
        from a11y.accessibility.rules.media.quality_engine import _check_verbatim
