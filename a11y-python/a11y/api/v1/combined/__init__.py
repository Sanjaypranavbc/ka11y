...
that existing callers (api/router.py, main.py) continue to work unchanged:
    ...
    from a11y.api.v1.combined import router        # api/router.py
    from a11y.api.v1.combined import _evict_old_jobs  # main.py
...
──────────────────────────────
Step 1 — Crawler  (a11y/crawler/)
  Implement async crawl() → List[Dict] + save_raw_json().

Step 2 — Auditor  (a11y/accessibility/rules/<category>/)
