"""
a11y/api/v1/combined/runner.py
=================================
...
from a11y.preprocessor.text_helper_models import _json_serializer
...
from a11y.utils.lang_detector import detect_page_language
from a11y.utils.run_timing import log_run_timing
from a11y.utils.stage_timing import emit_summary as emit_stage_timing_summary
...
_JOB_TIMEOUT_SECONDS = int(os.environ.get("A11Y_JOB_TIMEOUT_SECONDS", "1800"))
...
async def _run_job_body(
    ...
    try:
        ...
        if payload.run_node_audit:
            ...
            from a11y.crawler.axe_runner import is_unified_enabled, run_axe_unified
        ...
        # true multi-core parallelism when A11Y_CPU_WORKERS>0; otherwise run_cpu
