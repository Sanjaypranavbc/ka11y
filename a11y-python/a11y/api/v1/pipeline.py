...
from a11y.api.v1.models.pipeline import PipelineRequest, PipelineResponse
...
from a11y.accessibility.rules.non_text.alttext import AltTextAccessibilityAuditor
...
logger = setup_logger(name="AC", tag="pipeline")
...
async def run_full_pipeline(
    ...
    logger.info("=" * 60)
    logger.info("A11Y FULL PIPELINE START")
