...
def setup_logger(name: str = "AC", tag: str | None = None) -> KaLogger:
    """
    ...
    """
    # Absolute path so logs always land in a11y-python/logs/ regardless of CWD
    ...
    if not base.handlers:
        ...
        try:
            ...
            print(
                f"[a11y logger] WARNING: could not create log file at "
