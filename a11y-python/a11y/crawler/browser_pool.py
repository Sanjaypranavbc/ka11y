"""
a11y/crawler/browser_pool.py
=============================
Shared Playwright Chromium pool for a11y crawlers.

Background
----------
Sprint 2 (#9): each of the ten a11y crawlers — image, media, sensory,
...
_MAX_BROWSERS = int(os.environ.get("A11Y_MAX_BROWSERS", "2"))
