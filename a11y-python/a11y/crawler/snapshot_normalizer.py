...
from a11y.crawler.interactive_crawler import InteractiveElementData
from a11y.crawler.media_crawler import MediaElementData
from a11y.crawler.moving_content_crawler import MovingContentData
from a11y.crawler.sensory_crawler import SensoryElementData
...
logger = setup_logger(name="AC", tag="snapshot_normalizer")
