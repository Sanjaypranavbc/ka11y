...
from a11y.crawler.models import ImageData, ImageMetadata
from a11y.config.logger import setup_logger
from a11y.classifier.classifier import ClassifyAssets
from a11y.utils.config_loader import load_config

CONFIG = load_config()

console = Console(force_terminal=True)
logger = setup_logger(name="AC", tag="crawler")
                ...
                while queue:
                    ...
                    console.print(
                        Panel(
                            ...
                            title="[bold]a11y Image Crawler[/bold]",
                            border_style="cyan",
                        )
                    )
                    ...
                    try:
                        ...
                        # A11Y_STAGE_TIMING_DISABLE=1 or job_id is None).
                        from a11y.utils import stage_timing as _st
