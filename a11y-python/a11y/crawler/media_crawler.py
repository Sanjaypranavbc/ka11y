...
logger = setup_logger(name="AC", tag="media_crawler")
...
class AsyncMediaCrawler:
    ...
    async def crawl(self) -> List[MediaElementData]:
        ...
        from a11y.crawler.bfs import bounded_bfs
...
#   → File 2: a11y/accessibility/rules/media/__init__.py
#   → File 3: a11y/accessibility/rules/media/media_auditor.py
# ─────────────────────────────────────────────────────────────────────────
