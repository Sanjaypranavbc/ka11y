...
---------------------------------------
    from a11y.accessibility.audit import AccessibilityAuditor
...
logger = setup_logger(name="AC", tag="audit")
...
class AltTextAccessibilityAuditor:
    ...
    def _print_summary(self, records: list[dict], report_path: str):
        ...
        sep = "=" * 70
        print(f"\n{sep}")
        print("  A11Y — UNIFIED WCAG ACCESSIBILITY AUDIT REPORT")
