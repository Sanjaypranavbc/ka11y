"""
a11y/accessibility/rules/media/media_auditor.py
==================================================
...
logger = setup_logger(name="AC", tag="media_auditor")
...
class MediaAuditor:
    ...
    def _audit_single(self, item: Dict[str, Any], run_1_2_1: bool = True, run_1_2_2: bool = True) -> Dict[str, Any]:
        ...
        if media_type == "synchronized":
            ...
            from a11y.accessibility.rules.media.quality_engine import evaluate_captions_quality
    ...
    def _run_quality_checks(
        ...
        """
        from a11y.accessibility.rules.media.quality_engine import (
