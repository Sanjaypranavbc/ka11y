...
from a11y.preprocessor import extract_color
from a11y.accessibility.rules.non_text import contrast_analyser
from a11y.preprocessor.text_helper_models import (
    TextDetectionResult,
    TextDetectionReport,
    DetailedDetection,
    _json_serializer,
)
from a11y.utils.text_detector_helper import (
    estimate_boldness,
    bbox_height_rotated,
...
logger = setup_logger(name="AC", tag="text_detector")
logger.info("Logger initialized")

try:
    from a11y.text_detector.paddleocrbase import OCRReader, PaddleOCR
