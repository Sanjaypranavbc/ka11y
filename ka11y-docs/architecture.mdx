...
<CardGroup cols={3}>
  ...
  <Card title="ka11y-node" icon="node-js">
    **Port 3000 · Express**
    ...
    DOM accessibility engine. Injects axe-core into live pages via Puppeteer and runs 24 custom WCAG checks not covered by axe-core (focus traps, keyboard shortcuts, pointer cancellation, etc.).
  </Card>
...
graph TD
    ...
    I --> S["Stage 7–13: Rendered layout\nReflow, Resize, Orientation…"]
...
### Custom checks (24 rules beyond axe-core)

| Check | WCAG SC | Mode |
|---|---|---|
| custom-focus-visible | 2.4.7 | Interactive |
| custom-focus-appearance | 2.4.7 | Interactive |
...
| custom-error-suggestion | 3.3.5 | Static |
...
Pass findings carry `severity: null`, `suggested_fix: null`, and `element: null`.
