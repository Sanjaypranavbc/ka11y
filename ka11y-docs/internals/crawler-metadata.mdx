...
ka11y-python uses dedicated async crawler classes. Each crawler is responsible for a specific content type.
...
**Universal fields present in every crawler record:**
