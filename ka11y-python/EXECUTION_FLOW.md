...
*   **File:** `ka11y/main.py` & `ka11y/api/v1/combined/routes.py`
*   **Process:**
...
*   **File:** `ka11y/api/v1/combined/runner.py`
*   **Process:**
...
The core of `ka11y-python` is a multi-stage pipeline where each stage evaluates a specific set of WCAG criteria.

*   **File:** `ka11y/api/v1/combined/stages.py`
*   **Process:**
...
*   **File:** `ka11y/api/v1/combined/findings.py`
