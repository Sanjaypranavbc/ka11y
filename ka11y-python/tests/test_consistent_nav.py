...
from ka11y.accessibility.rules.navigation import consistent_nav
from ka11y.api.v1.combined.findings import _consistent_navigation_to_findings
...
async def test_analyze_wcag_323_needs_review_on_no_pages():
    with patch("ka11y.accessibility.rules.navigation.consistent_nav.leased_context") as mock_lease:
        mock_ctx = AsyncMock()
        mock_page = AsyncMock()
