...
from ka11y.accessibility.rules.navigation import consistent_id
from ka11y.api.v1.combined.findings import _consistent_id_to_findings
...
async def test_analyze_wcag_324_crawls_and_analyzes():
    with patch("ka11y.accessibility.rules.navigation.consistent_id.leased_context") as mock_lease:
        mock_ctx = AsyncMock()
        mock_page = AsyncMock()
