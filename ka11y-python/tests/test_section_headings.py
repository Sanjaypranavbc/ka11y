...
from ka11y.accessibility.rules.rendered import section_headings
from ka11y.api.v1.combined.findings import _section_headings_to_findings
...
async def test_analyze_wcag_2410_crawls():
    with patch("ka11y.accessibility.rules.rendered.section_headings.leased_context") as mock_lease:
        mock_ctx = AsyncMock()
        mock_page = AsyncMock()
        mock_page.evaluate = AsyncMock(return_value={
            "title": "Page Title",
