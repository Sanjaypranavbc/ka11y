"""
ka11y/api/v1/combined/dispatcher.py
==================================
...
* It drains ``queued`` rows in FIFO order, bounded by ``KA11Y_MAX_CONCURRENT_JOBS``.
...
logger = setup_logger(name="KAC", tag="combined.dispatcher")
